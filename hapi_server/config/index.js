...
proto.checkDefaultWeb = function(){
  this.options.servers.web.port = this.options.servers.web.port || 0;
  this.options.servers.web.host = this.options.servers.web.host || 'localhost';
}
